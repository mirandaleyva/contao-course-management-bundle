...
$GLOBALS['TL_LANG']['tl_course_date']['location_legend'] = 'Ort';
$GLOBALS['TL_LANG']['tl_course_date']['status_legend'] = 'Status';

$GLOBALS['TL_LANG']['tl_course_date']['new'] = ['Neuer Kurstermin', 'Einen neuen Kurstermin erstellen'];
$GLOBALS['TL_LANG']['tl_course_date']['show'] = ['Details', 'Die Details des Kurstermins ID %s anzeigen'];
$GLOBALS['TL_LANG']['tl_course_date']['edit'] = ['Bearbeiten', 'Kurstermin ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_course_date']['copy'] = ['Duplizieren', 'Kurstermin ID %s duplizieren'];
$GLOBALS['TL_LANG']['tl_course_date']['delete'] = ['Löschen', 'Kurstermin ID %s löschen'];
$GLOBALS['TL_LANG']['tl_course_date']['toggle'] = ['Veröffentlichen', 'Den Veröffentlichungsstatus des Kurstermins ändern'];
